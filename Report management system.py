#   Project name:   STUDENT REPORT CARD MANAGEMENT SYSTEM
#   Made by:        TEAM 15 CSE-A 2nd Year
...
def add_student():
    conn = mysql.connector.connect(
        host='localhost', database='report_card', port='3306', user='root', password='priyanka@1111')
    cursor = conn.cursor()
    clear()
...
def allstudents():
    ...
    t = PrettyTable(['admno', 'Name', 'Father Name','class','section','status'])
    ...
    for adno,n,fn,cl,sec,sta in records:

      t.add_row([adno,n,fn,cl,sec,sta])
